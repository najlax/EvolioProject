            ...
            <Card className="border-violet-100 bg-violet-50/60">
              <div className="mb-2 flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="card-title mb-0 text-[#199DB2]">AI Portfolio Summary</h3>
                </div>
                <span className="text-xs text-[#199DB2]">
              ...
              <div className="mt-4 border-t border-violet-100 pt-3">
                <p className="flex items-center gap-2 text-sm text-[#199DB2]">
          ...
          <div className="space-y-6">
            ...
            <Card>
              <div className="mb-2 flex items-center gap-2">
                <Bot className="h-5 w-5 text-[#199DB2]" />
