      ...
      <div className="mx-auto max-w-3xl px-4 py-8">
        {loading ? (
          ...
          <div className="space-y-6">
            ...
            {/* AI Portfolio Summary - visible to everyone who opens the portfolio */}
            {profile?.ai_summary && (
              <Card className="border-[#199DB2]/30 bg-[#F4FBFC]">
                <div className="mb-2 flex items-center justify-between gap-2">
                  <div className="flex items-center gap-2">
                    <Sparkles className="h-5 w-5 text-[#199DB2]" />
                    <h2 className="card-title mb-0">AI Portfolio Summary</h2>
                  </div>
                  <span className="hidden text-xs text-gray-400 sm:block">
                    Generated by Evolio AI
                  </span>
                </div>
            ...
            {profile?.user_id && (
              <PortfolioChatbot studentId={profile.user_id} studentName={profile.name} />
            )}
          </div>
        )}
      </div>
